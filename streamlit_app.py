...
def estimate_calories(entry_type: str, name: str, image_bytes: bytes) -> tuple[int, str]:
    ...
    if matches:
        ...
        return average, f"auto (mot-clé: {matches[0][0]})"
...
st.info(
    "Si calories vide: l'app essaie d'abord les mots-clés du nom. "
    "Si aucun mot-clé, elle fait une estimation basée sur la photo (plus de 550 fixe)."
)
